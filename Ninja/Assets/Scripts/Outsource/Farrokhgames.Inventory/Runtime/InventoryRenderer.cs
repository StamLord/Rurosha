...
namespace FarrokhGames.Inventory
{
    ...
    public class InventoryRenderer : MonoBehaviour
    {
        ...
        [SerializeField] private bool scaleIcons;
        ...
        */
        ...
        {
            float largestDimension = MathF.Max(img.sprite.rect.width, img.sprite.rect.height);
            float scale = cellSize.x / largestDimension;

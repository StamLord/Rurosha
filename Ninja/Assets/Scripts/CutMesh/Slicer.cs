...
namespace Assets.Scripts
{
    class Slicer
    {
        ...
        {            
            ...
            Vector3 dimensions = new Vector3(mesh.bounds.size.x * objectToCut.transform.localScale.x, 
                                            mesh.bounds.size.y * objectToCut.transform.localScale.y,
                                            mesh.bounds.size.z * objectToCut.transform.localScale.z);
            ...
            SlicesMD slicesMeta = new SlicesMD(mesh, plane, true);            

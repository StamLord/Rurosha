    ...
    {   
        ...
        if(hurtbox)
        {
            ...
            if(ValidateState(heavyAttackStates))
                hurtbox.Hit(agent, heavyAttackDamage.softDamage, heavyAttackDamage.hardDamage, hitbox.transform.right, hitbox.Velocity, DamageType.Slash);
            // Light Attack
            else
                hurtbox.Hit(agent, lightAttackDamage.softDamage, lightAttackDamage.hardDamage, hitbox.transform.right, hitbox.Velocity, DamageType.Slash);
        }

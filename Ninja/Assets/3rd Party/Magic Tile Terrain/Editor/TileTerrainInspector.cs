    ...
    public class TileTerrainInspector : Editor
    {
            ...
            if (_atlasTextures != null)
            {
                ...
                for (int i = 0; i < _rows; i++)
                {
                    ...
                    for (int n = 0; n < _texturesPerRow; n++)
                    {
                        ...
                        {
                            _target.SetTileTexture(_target.gizmoPosition, _texIndex);
                            _target.SetToUnityMesh();
                        }
      ...
      */
        ...
        void DrawMeshInfo()
        {
            ...
            "Triangles: " + _target.tMesh.trianglesCount + Environment.NewLine +
            "Vertices: " + _target.tMesh.vericesCount + Environment.NewLine +
            "UVs: " + _target.tMesh.uvCount;
            ;
        ...
        {
            //EditorGUILayout.HelpBox("Set Texture:", MessageType.None);
